...
## (2) Detect circles
	...
	# 		# Drawing a rectangle on c
		...
		#dr=280
		#print(x,y,dr)
		croped = image3[cy-345:cy+345,cx-380:cx+380].copy()
		...
		# cols=h
		#cv2.imshow("",croped)
		dst = cv2.warpPolar(croped, (int(h*3.5),int(w*3)),(c_rx,c_ry),(w/2)-30, flags=(cv2.WARP_POLAR_LOG))
		dst1 = cv2.warpPolar(croped1, (int(h*3.5),int(w*3)),(c_rx,c_ry),w/2, flags=(cv2.WARP_POLAR_LOG))
		...
		mydb.commit()
		msg = {"ID":ID,"WheelNoL": wheelIDL, "WheelNoR": wheelIDR, "CropImgL": crp_urlL,"CropImgR":crp_urlR,"FullImg":full_img}
		print(msg)
